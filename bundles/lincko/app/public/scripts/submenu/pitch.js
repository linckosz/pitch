submenu_list['app_pitch_new'] = {
	...
	"pitch_title": {
		...
		"value": function(){
			...
			return Lincko.Translation.get('app', 2103, 'html', param); //Pitch #[{number]}
		},
...
submenu_list['app_pitch_edit'] = {
	...
	"pitch_title": {
		...
		"value": function(Elem, subm){
			return Lincko.storage.get('pitch', subm.param, 'title');
		},
	...
	"deletion": {
		...
		"action": function(Elem, subm){
			if(confirm(Lincko.Translation.get('app', 26, 'js'))){ //Are you sure you want to delete this item?
				...
				data.delete = {};
				data.delete.pitch = {};
				var item = Lincko.storage.get('pitch', subm.param);
