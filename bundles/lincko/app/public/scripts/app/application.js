...
$("body").on("mousedown blur focusin focusout", ".selectable", function(event) { 
	...
	if(scroll){
		...
		} else if(typeof iscroll_disabled[iscroll_id] == 'undefined' || iscroll_disabled[iscroll_id]){
			iscroll_disabled[iscroll_id] = false;
			scroll.enable();//enables the iScroll
		}
